        ...
        <div className="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 lg:border-r lg:border-gray-200 lg:pt-5 lg:pb-4 lg:bg-blue-200">
          ...
          <div className="mt-6 h-0 flex-1 flex flex-col overflow-y-auto">
            ...
            <Menu as="div" className="px-3 relative inline-block text-left">
              <div>
                <Menu.Button className="group w-full bg-blue-100 rounded-md px-3.5 py-2 text-sm text-left font-medium text-gray-700 hover:bg-blue-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-blue-100">
            ...
            <div className="px-3 mt-5">
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  name="search"
                  id="search"
                  className="focus:ring-indigo-100 bg-blue-100 focus:border-indigo-100 block w-full pl-9 sm:text-sm border-gray-300 rounded-md"
                  placeholder="Search"
                />
              </div>
            </div>
...
export default LecturersPortal;
